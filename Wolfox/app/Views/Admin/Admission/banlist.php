...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Banned Student List</h4>
                                     ...
                                     ?>
                                            <tr>
                                                ...
                                                <td><?php echo $row['collegename'] ?></td>
                                                 <td>
                                            <form action="<?php echo base_url('/Student/unban')?>" method="post">    
                                                <input type="text" name="banid" id="banid" value="<?php echo $row['sid']?>" hidden>
                                            <button type="submit" class="form-control" style="background-color: #2962ff;color:aliceblue;border-radius:10px"><i class="fa-solid fa-circle-check"></i></button>
                                            </form>
                                            </td>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
          ...
          <!-- Bootstrap Modal -->
          <div class="modal fade" id="unbanmodel" tabindex="-1" aria-labelledby="successModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="successModalLabel">Notification</h5>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            <?php if (session()->getFlashdata('unban')) : ?>
                var successModal = new bootstrap.Modal(document.getElementById('unbanmodel'));
                successModal.show();
                setTimeout(() => {
                    successModal.hide();
                }, 1000); // Auto-close after 3 seconds
