                    ...
                    <form enctype="multipart/form-data" action="<?php echo base_url('/Admin/Admission/Update'); ?>" method="POST" class="validation-wizard wizard-circle m-t-40">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" pattern="[6-9][0-9]{9}" class="form-control" id="PhoneNo" name="PhoneNo" value="<?php echo $StudentData['whatsappno'] ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="WhatsappNo">Whatsapp Number</label>
                                        <input type="tel" pattern="[6-9][0-9]{9}" class="form-control" id="WhatsappNo" name="WhatsappNo" value="<?php echo $StudentData['whatsappno'] ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <section>
                            <div class="row">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <select name="collegeid" id="collegeid" class="form-control">
                                        <?php foreach ($CollegeData as $row): ?>
                                            <option value="<?= $row['id']; ?>" <?= ($StudentData['collegeid'] == $row['id']) ? 'selected' : ''; ?>>
                                                <?= $row['collegename']; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <!-- <div class="col-md-6"> -->
                                    <!-- <label for="Branch">College Village</label>
                                    <input type="text" class="form-control" id="collegevillage" name="collegevillage" value="<?php echo $StudentData['collegevillage'] ?>"> -->
                                <!-- </div> -->
                                <div class="col-sm-6">
                                    <br>
                                    ...
                                    <select name="branchid" id="branchid" class="form-control">
                                        <?php foreach ($BranchData as $row): ?>
                                            <option value="<?= $row['id']; ?>" <?= ($StudentData['branchid'] == $row['id']) ? 'selected' : ''; ?>>
                                                <?= $row['branchname']; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="Year" id="Year" class="form-control" value="<?php echo $StudentData['year'] ?>">
                                        ...
                                        <option value="FirstYear" <?= ($StudentData['year'] == 'FirstYear') ? 'selected' : '' ?>>FirstYear</option>
                                        <option value="SecondYear" <?= ($StudentData['year'] == 'SecondYear') ? 'selected' : '' ?>>SecondYear</option>
                                        <option value="ThirdYear" <?= ($StudentData['year'] == 'ThirdYear') ? 'selected' : '' ?>>ThirdYear</option>
                                        <option value="FourthYear" <?= ($StudentData['year'] == 'FourthYear') ? 'selected' : '' ?>>FourthYear</option>
                                        <option value="Passout" <?= ($StudentData['year'] == 'Passout') ? 'selected' : '' ?>>Passout</option>
                                    </select>
                                </div>
                            </div>
                        </section>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <option value="">Select Course</option>
                                        ...
                                        <?php foreach ($CourseData as $row): ?>
                                            <option value="<?= $row['courseid']; ?>" <?= ($StudentData['courseid'] == $row['courseid']) ? 'selected' : ''; ?>>
                                                <?= $row['course']; ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                    ...
                                    <select name="batchid" id="batchid" class="form-control">
                                        ...
                                        <?php foreach ($BatchData as $row) : ?>
                                            <option value="<?php echo $row['batchid']; ?>"
                                                <?= ($StudentData['batchid'] == $row['batchid']) ? 'selected' : ''; ?>>
                                                <?php echo $row['batchname'] . ' ' . date("h:i A", strtotime($row['starttime'])) . ' - ' . date("h:i A", strtotime($row['endtime'])); ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="guidename" id="guidename" class="form-control" value="<?php echo $StudentData['guidename'] ?>">
                                        ...
                                        <option value="[EMP-] Shridhar Khot, CEO & Director (Chief Executive Officer)" <?= ($StudentData['guidename'] == '[EMP-] Shridhar Khot, CEO & Director (Chief Executive Officer)') ? 'selected' : '' ?>>[EMP-] Shridhar Khot, CEO & Director (Chief Executive Officer)</option>
                                        <option value="[EMP-010] Bhagyashri S. Khot, HOD & Director (Chief Technical Officer)" <?= ($StudentData['guidename'] == '[EMP-010] Bhagyashri S. Khot, HOD & Director (Chief Technical Officer)') ? 'selected' : '' ?>>[EMP-010] Bhagyashri S. Khot, HOD & Director (Chief Technical Officer) </option>
                                    </select>
                                </div>
                            </div>
                        </section>
