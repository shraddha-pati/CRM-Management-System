...
<div class="page-wrapper">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url('/Admin/Admission/Form') ?>" aria-expanded="false">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="row" style="display: flex; justify-content:space-around;">
                                                        <a href="<?php echo base_url('/Admin/Admission/Edit/' . $row['studid'] . '') ?>">
                                                        ...
                                                        <?php if (!empty($row['firstname']) && !empty($row['lastname'])  && !empty($row['dob']) && !empty($row['gender'])) { ?>
                                                            <?php if ($row['totalfee'] == $row['paidfee']) { ?>
                                                            <?php } else { ?>
                                                                <?php if ($row['installment'] == '') { ?>
                                                                    <?php if ($row['totalfee'] == $row['paidfee']) { ?>

                                                                        <!-- <div style="text-align:center;font-size:20px;color:gray">
                                                                        <i class="fa-solid fa-indian-rupee-sign" style="pointer-events: none;"></i>
                                                                    </div> -->
                                                                    <?php } else if ($row['installment_number'] == 1) { ?>

                                                                        <a href="<?php echo base_url('/Admin/Admission/fee1/' . $row['id']) ?>" class="openFeeStatusModal">
                                                                    ...
                                                                    <?php } else { ?>
                                                                        <a href="<?php echo base_url('/Admin/Admission/fee2/' . $row['id']) ?>" class="openFeeStatusModal">
                                                                            <div style="text-align:center;font-size:20px;color:blue">
                                                                                <i class="fa-solid fa-indian-rupee-sign"></i>
                                                                            </div>
                                                                        </a>
                                                                    ...
                                                                    <a href="<?php echo base_url('/Admin/Admission/fee3/' . $row['id']) ?>" class="openFeeStatusModal">
                                                                        <div style="text-align:center;font-size:20px;color:blue">
                                                                            <i class="fa-solid fa-indian-rupee-sign"></i>
                                                                        </div>
                                                                    </a>
                                                            ...
                                                            <a href="#" class="openStudentInfoModal"
                                                                ...
                                                                data-collegevillage="<?= $row['collegevillage']; ?>"
                                                                ...
                                                                data-updatedpassword="<?= $row['newpassword']; ?>"
                                                            ...
                                                            <!-- data-remainingfee="<?php  // $row['remaining_fee']; 
                                                                                    ?>"  -->
                                                    ...
                                                    <?php } else { ?>
                                                        <div style="display: flex; justify-content:space-between">
                                                            ...
                                                            if (($row['mode']) === 'cash') { ?>
                                                                ...
                                                                <a href="<?php echo base_url('/Admin/Admission/feereceipt/' . $row['sid']) ?>" title="Paid via Cash">
                                                                    <!-- <i class="fa-solid fa-money-bill-wave" ></i> -->
                                                                    <i class="fa-solid fa-receipt" style="font-size:22px;padding:0;margin:0;" class="icon-link"></i>
                                                                </a>
                                                            <?php } ?>
                                                        </div>
                                                    <?php } ?>
                                                ...
                                                <td>
                                                    ...
                                                    if (
                                                        ...
                                                        <a href="#" onclick="handleOnlineButtonClick(
                                                                    <?php echo $row['id']; ?>,
                                                                    <?php echo $row['totalfee']; ?>,
                                                                     <?php echo $row['installment']; ?>,
                                                                    <?php echo $row['installment_number']; ?>
                                                                )">
                                                            <button style="font-size:15px; background-color:#28a745; color:white;border:none;border-radius:20px">Online</button>
                                                        </a>


                                                        <!-- <form action="<?php echo base_url('/Admin/Admission/confirmdocument') ?>" method="post">
                                                            ...
                                                            <button class="form-control" type="submit" name="submit" style="margin-top: 20px; background-color:#5f86f0; color:white; border-radius:12px;width:90px">
                                                                Submit
                                                            </button>
                                                        </form> -->

                                                    <?//php } elseif ($row['mode'] === 'online' && $row['confirmstatus'] == 1) { ?>

                                                        <a href="<?php echo base_url('/uploads/feedocument/' . $row['sid'] . '/' . $row['filename']); ?>" title="view document">
                                                            <!-- <i class="fa-solid fa-circle-check" style="font-size:22px;padding:0;margin:0;" class="icon-link"></i> -->
                                                            <!-- <button style="font-size:15px; background-color:#28a745; color:white;border:none;border-radius:20px">Online</button> -->
                                                        </a>
                                            ...
                                            <td><?php echo $row['pstreet'] ?>,<?php echo $row['pcity'] ?>,
                                                ...
                                                <td>
                                                    <form action="<?php echo base_url('/Student/ban') ?>" method="post">
                                                        <input type="text" name="banid" id="banid" value="<?php echo $row['sid'] ?>" hidden>
                                                        <button type="submit" class="form-control" style="background-color: #2962ff;color:aliceblue;border-radius:10px"><i class="fa-solid fa-ban"></i></button>
                                                    </form>
                                                </td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <p><b style="color:black"> Address:</b> <span id="studentPaddress"></span></p>
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <p><b style="color:black">Password:</b> <span id="password"></span></p>
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <p><b style="color:black">Updated Password:</b> <span id="updatedpassword"></span></p>
                        </div>
                        <!-- <div class="col-md-6">
    ...
    <script>
        function handleOnlineButtonClick(id, totalFee,installment, installmentNumber) {
            // if (totalFee === paidFee) {
            //     alert("All fees are paid. No further installments required.");
            //     return;
            // }

            //console.log(installmentNumber);

            // Check if installment is empty or undefined, and handle different conditions based on the installment number
            if (!installment || installment == 0) { // This checks if installment is falsy (undefined, null, or empty string)
                if (installmentNumber === 1) {
                    // Redirect to fee page 1
                    window.location.href = "<?php echo base_url('/Admin/Admission/fee1/'); ?>" + id;
                } else {
                    // Redirect to fee page 2
                    window.location.href = "<?php echo base_url('/Admin/Admission/fee2/'); ?>" + id;
                }
            } else {
                // If installment is not empty, it must be fee page 3
                window.location.href = "<?php echo base_url('/Admin/Admission/fee3/'); ?>" + id;
            }
        }
    </script>
    ...
    <script>
        $(".openStudentInfoModal").on("click", function() {
            ...
            var collegevillage = $(this).data("collegevillage");
            ...
            var updatedpassword = $(this).data("updatedpassword");
            ...
            $("#collegevillage").text(collegevillage);
            ...
            $("#updatedpassword").text(updatedpassword);
