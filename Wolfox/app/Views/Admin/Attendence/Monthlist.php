            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Attendence List</h4>
    ...
    <div class="form-group">
        <button type="button" class="btn btn-primary w-100 btn-rounded batch-btn" data-month="1" style="margin-top: 30px;">January</button>
    </div>
</div>

<div class="col-md-4">
    <div class="form-group">
       <button type="button" class="btn btn-primary w-100 btn-rounded batch-btn" data-month="2" style="margin-top: 30px;">February</button></a>
    </div>
</div>

<div class="col-md-4">
    <div class="form-group">
        <button type="button" class="btn btn-primary w-100 btn-rounded batch-btn" data-month="3" style="margin-top: 30px;">March</button>
    </div>
</div>
...
<div class="col-md-4">
    <div class="form-group">
        <button type="button" class="btn btn-primary w-100 btn-rounded batch-btn" data-month="4" style="margin-top: 30px;">April</button>
    </div>
</div>

<div class="col-md-4">
    <div class="form-group">
        <button type="button" class="btn btn-primary w-100 btn-rounded batch-btn" data-month="5" style="margin-top: 30px;">May</button>
    </div>
</div>

<div class="col-md-4">
    <div class="form-group">
        <button type="button" class="btn btn-primary w-100 btn-rounded batch-btn" data-month="6" style="margin-top: 30px;">June</button>
    </div>
</div>

<div class="col-md-4">
    <div class="form-group">
        <button type="button" class="btn btn-primary w-100 btn-rounded batch-btn" data-month="7" style="margin-top: 30px;">July</button>
    </div>
</div>
...
<div class="col-md-4">
    <div class="form-group">
        <button type="button" class="btn btn-primary w-100 btn-rounded batch-btn" data-month="8" style="margin-top: 30px;">August</button>
    </div>
</div>

<div class="col-md-4">
    <div class="form-group">
        <button type="button" class="btn btn-primary w-100 btn-rounded batch-btn" data-month="9" style="margin-top: 30px;">September</button>
    </div>
</div>

<div class="col-md-4">
    <div class="form-group">
        <button type="button" class="btn btn-primary w-100 btn-rounded batch-btn" data-month="10" style="margin-top: 30px;">Octomber</button>
    </div>
</div>

<div class="col-md-4">
    <div class="form-group">
        <button type="button" class="btn btn-primary w-100 btn-rounded batch-btn" data-month="11" style="margin-top: 30px;">November</button>
    </div>
</div>

<div class="col-md-4">
    <div class="form-group">
        <button type="button" class="btn btn-primary w-100 btn-rounded batch-btn" data-month="12" style="margin-top: 30px;">December</button>
    </div>
</div>
<!-- Add remaining months similarly -->

<!-- Display Batch List Here -->
<div class="col-md-12">
...
<script>
    $(document).ready(function () {
        const currentMonth = new Date().getMonth() + 2; // getMonth() is zero-based

        // ✅ Hide all buttons except the current month
        $(".batch-btn").each(function () {
            let month = $(this).data("month");
            if (month !== currentMonth) {
                $(this).closest(".col-md-4").hide(); // Hide the entire column
            }
        });

        // ✅ Redirect when current month button is clicked
        $(".batch-btn").click(function () {
            let month = $(this).data("month");
            window.location.href = "<?= base_url('admin/Attendence/batchList/') ?>" + month;
        });
    });
</script> -->
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script>
    $(document).ready(function () {
        const currentMonth = new Date().getMonth() + 1; // ✅ getMonth() is zero-based (Jan=0)

        // ✅ Show months from January to the current month
        $(".batch-btn").each(function () {
            let month = parseInt($(this).data("month"));
            if (month > currentMonth) {
                $(this).closest(".col-md-4").hide(); // Hide months greater than the current month
            }
        });

        // ✅ Redirect when a month button is clicked
        $(".batch-btn").click(function () {
            let month = $(this).data("month");
            window.location.href = "<?= base_url('admin/Attendence/batchList/') ?>" + month;
        });
