                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-flex no-block justify-content-end align-items-center">
                                    <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url('/Admin/ClientMaster/Add') ?>" aria-expanded="false">

                                        <button type="button" class="btn waves-effect waves-light btn-infonew">Add Client </button>
                                    </a>
                                </div>
                                        ...
                                        <tbody>
                                            <?php foreach ($clientdata as $row): ?>
                                                <tr>
                                                    ...
                                                    <td> <a href="<?php echo base_url() . 'Admin/ClientMaster/edit/' . $row['id'] . '' ?>">
                                                        ...
                                                        <br>
                                                        <a href="<?php echo base_url() . 'Admin/ClientMaster/delete/' . $row['id'] . '' ?>">
