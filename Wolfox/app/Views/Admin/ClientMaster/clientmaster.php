                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-30" action="<?php echo base_url('Admin/ClientMaster/save')?>" method="POST" >
								...
								<div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="BusinessName" id="BusinessName"  placeholder="Enter BusinessName" >
                                         </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="DomainName" id="DomainName"  placeholder="Enter DomainName" >
                                         </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control" name="PhoneNo" id="PhoneNo" placeholder="PhoneNo" >
                                    </div>
									</div>
