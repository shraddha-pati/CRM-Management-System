...
class AdminDashboard extends BaseController
{
	public function list()
	{
		...
		$callInquiryCount = $AdmissionModel
		->where('inquirytype', 1)
		->countAllResults();
		$data['callInquiryCount'] = $callInquiryCount;
		print_r($callInquiryCount);exit;
		...
		$AdmissionModel = new AdmissionModel();
		$currentMonth = date('m');
		$totaladmission = $AdmissionModel->where("joiningdate")->countAllResults();
