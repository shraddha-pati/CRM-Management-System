     ...
     <div class="page-breadcrumb">
         <div class="row">
             <div class="col-5 align-self-center">
                 <!-- <h4 class="page-title">Student Inquiry List</h4> -->
                     ...
                     <div class="card">
                         <div class="card-body">
                             ...
                             <div class="d-flex no-block justify-content-end align-items-center">
                                 <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url('/Admin/Inquiry/add') ?>" aria-expanded="false">
                             ...
                             <div class="table-responsive">
                                 <table class="table display" id="example" style="width:100%">
                                     ...
                                     <tbody>
                                         <?php foreach ($InquiryMasterModel as $row): ?>
                                             <tr>
                                                 <td><?= $row['id'] ?></td>
