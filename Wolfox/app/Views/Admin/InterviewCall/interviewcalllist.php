            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Interview Call List</h4>
                                <div class="d-flex no-block justify-content-end align-items-center">
                             <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?php echo base_url('/Admin/InterviewCall/Add')?>" aria-expanded="false">
        ...
        <tr>
             ...
             <a href="<?php echo base_url().'Admin/InterviewCall/edit/'.$row['id'].''?>"><div style="width: 60px; border:1px solid #2962ff;text-align:center;border-radius:5px;background-color: #2962ff !important;;color:white">Edit</div></a>
                                                <br>
         <a href="<?php echo base_url().'Admin/InterviewCall/delete/'.$row['id'].'' ?>"><div style="width: 60px; border:1px solid red;text-align:center;border-radius:5px;background-color: red !important;;color:white">Delete</div></a></td>
            ...
            <td><?php echo $row['companynames']; ?></td>
