        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="<?php echo base_url('/Admin/DashBoard/list') ?>" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Dashboard Master</span></a>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Inquiry Master </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="<?php echo base_url('/Admin/Inquiry/add') ?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Inquiry Add</span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Call Inquiry Master </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="<?php echo base_url('/Admin/CallInquiry/Form') ?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Call Inquiry Form </span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Course Master </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="<?php echo base_url('/Admin/Course/Form') ?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Course Form </span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Certificate Master </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="<?php echo base_url('/Admin/Fee/list') ?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> List </span></a></li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Other Letter Master </span></a>
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="<?php echo base_url('/Admin/OtherLetter/Add') ?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu">Other Letter Add </span></a></li>
                                <li class="sidebar-item"><a href="<?php echo base_url('/Admin/OtherLetter/list') ?>" class="sidebar-link"><i class="mdi mdi-adjust"></i><span class="hide-menu"> Other Letter List </span></a></li>
                            </ul>
                        </li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Other Letter List</h4>
                                ...
                                <h4 class="card-title">Default Table</h4>
                                   <div class="table-responsive">
                                    <table class="table" id="example">
                                        ...
                                        <tbody>
 <?php foreach ($letterdata as $row): ?>
        <tr>
            
             <td><a href="<?php echo base_url().'Admin/OtherLetter/delete/'.$row['id'].'' ?>"><i class="fas fa-trash-alt"></i></a>
                 <td><?php echo ''.$row['id'].''?></td>								  
            <td><?php echo $row['name']; ?></td>
            <td><img src="<?php echo base_url() . 'uploads/otherletter/' . $row['id'] . '/' . $row['Image']; ?>" style="width: 200px; height: 150px;"></td>
