...
<div class="page-wraper">
    ...
    <div class="sidebar">
		<div class="author-box">
			<div class="dz-media">
				<img src="<?php echo base_url('assets/images/author/pic1.png')?>" class="rounded-circle" alt="author-image">
			</div>
			<div class="dz-info">
    ...
    <div class="container">
        ...
        <div class="button-group">
            <button type="button" class="btn btn-primary w-100 btn-rounded" style="margin-top: 30px;" id="cashBtn">Cash</button>
            <button type="button" class="btn btn-primary w-100 btn-rounded" style="margin-top: 25px;" id="onlineBtn">Online</button>
        </div>

        <!-- Cash Payment: Show Voucher -->
        <div id="cashSection" style="display: none; margin-top: 20px;">
            <h4>Download Voucher</h4>
            <a href="path/to/voucher.pdf" class="btn btn-success" download>Download</a>
        </div>

        <!-- Online Payment: Show Upload Option -->
        <div id="onlineSection" style="display: none; margin-top: 20px;">
            <h4>Upload Receipt</h4>
            <input type="file" id="receiptUpload" class="form-control">
            <button type="button" class="btn btn-success" style="margin-top: 10px;">Upload</button>
        </div>
    </div>
</div>
...
document.getElementById("cashBtn").addEventListener("click", function() {
    ...
    let onlineSection = document.getElementById("onlineSection");
    ...
    if (cashSection.style.display === "block") {
        ...
        onlineSection.style.display = "none"; // Hide online section if it's visible
    }
});
...
document.getElementById("onlineBtn").addEventListener("click", function() {
    ...
    // Toggle visibility
    if (onlineSection.style.display === "block") {
        onlineSection.style.display = "none";
    } else {
        onlineSection.style.display = "block";
        cashSection.style.display = "none"; // Hide cash section if it's visible
    }
});
</script>
