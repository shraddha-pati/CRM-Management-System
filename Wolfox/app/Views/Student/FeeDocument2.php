     ...
     <div class="page-wraper">
         ...
         <div class="page-content">
             ...
             <div class="form-container" data-aos="zoom-in">
                 ...
                 <form class="animated-form" action="<?php echo base_url('/student/feedocumentsave') ?>" method="POST" enctype="multipart/form-data">
                     <div class="form-group">
                         <label>Upload Payment ScrenShort</label>
                     ...
                     <div class="form-group">
                         ...
                         <input type="date" class="custom-file-input" name="paymentdate" id="paymentdate" style=" border: 2px solid #0093dd;
                padding: 10px;
                text-align: center;
                cursor: pointer;
                width: 100%;
