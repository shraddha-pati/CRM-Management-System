    ...
    <div class="page-wraper">
        ...
        <div class="page-content">
            ...
            <div class="form-container" data-aos="zoom-in">
                ...
                <form class="animated-form" action="<?php echo base_url('/Student/mentorsave') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="custom-file-label" name="mentorname" id="mentorname">
                    </div>

                    <div class="form-group">
                        <label>Mentor Contact Number</label>
                        <input type="text" class="custom-file-label" name="mentornumber" id="mentornumber">
                    </div>
