         ...
         <div class="container">
             <div class="header-content">
                 ...
                 <div class="mid-content">
                     ...
                     <h5 class="mb-0" style="color: #0093dd;">Mentor List</h5>
 ...
 <div class="container">
     <!-- <h3 class="mb-3" style="color: #0093dd;">Fee List</h3> -->
     ...
     <div class="table-responsive">
         <table class="table table-bordered table-striped">
             ...
             <? //php if(!empty($row['paidfee']) && !empty($row['installment'])) {
                ?>
             <tbody>
                <?php foreach($mentor as $row): ?>
                 <tr>
                     ...
                     <td>
                        <a href="<?php echo base_url('/student/mentoredit/' . $row['id'] . '') ?>"><i class="fa fa-pencil" style="color: #0093dd;"></i></a>
                     </td>
...
<div class="menubar-area">
 ...
 <script>
     ...
     if (rows.length > 0) {
         ...
         addButton.href = `<?= base_url('/Student/feedocument/') ?>${lastFeeId}`;
     }
 </script>
 </body>
