    ...
    <div class="page-wraper">
        ...
        <div class="page-content">
            ...
            <div class="form-container" data-aos="zoom-in">
                ...
                <form class="animated-form" action="<?php echo base_url('/student/mentorupdate') ?>" method="POST" enctype="multipart/form-data">
                    <div class="form-group" hidden>
                        <input type="text" class="custom-file-label" name="id" id="id" value="<?php echo $mentor['id'] ?>">
                    </div>
                    <div class="form-group" hidden>
                        <input type="text" class="custom-file-label" name="sid" id="sid" value="<?php echo $id ?>">
                    </div>
                    <div class="form-group">
                        <label>Choose College</label>
                        <select name="collegeid" id="collegeid" class="custom-file-label">
                            <option value="">Select College Name</option>
                            <?php foreach ($CollegeData as $row) : ?>
                                <option value="<?php echo $row['id'] ?>" <?= ($mentor['collegeid'] == $row['id']) ? 'selected' : ''; ?>>
                    ...
                    <div class="form-group">
                        <label>Year</label>
                        <select class="custom-file-label" id="year" name="year">
                            <option value="">Select Year</option>
                            <option value="FirstYear" <?php echo ($mentor['year'] == 'FirstYear') ? 'selected' : ''; ?>>FirstYear</option>
                            <option value="SecondYear" <?php echo ($mentor['year'] == 'SecondYear') ? 'selected' : ''; ?>>SecondYear</option>
                            <option value="ThirdYear" <?php echo ($mentor['year'] == 'ThirdYear') ? 'selected' : ''; ?>>ThirdYear</option>
                            <option value="FourthYear" <?php echo ($mentor['year'] == 'FourthYear') ? 'selected' : ''; ?>>FourthYear</option>
                            <option value="Passout" <?php echo ($mentor['year'] == 'Passout') ? 'selected' : ''; ?>>Passout</option>
                        </select>
                    </div>
                    <div class="form-group">
                        <label>Date</label>
                        <input type="date" class="custom-file-label" name="date" id="date" value="<?php echo $mentor['date'] ?>">
                    </div>
                    <div class="form-group">
                        <label>Mentor Name</label>
                        <input type="text" class="custom-file-label" name="mentorname" id="mentorname" value="<?php echo $mentor['mentorname'] ?>">
                    </div>
                    <div class="form-group">
                        <label>Mentor Contact Number</label>
                        <input type="text" class="custom-file-label" name="mentornumber" id="mentornumber" value="<?php echo $mentor['mentornumber'] ?>">
                    </div>
