      ...
      <div class="page-wraper">
          ...
          <div class="page-content" style="margin-bottom:100px">
              ...
              <div class="form-container" data-aos="zoom-in">
                  ...
                  <form class="animated-form" action="<?php echo base_url('/Student/profileupdate') ?>" method="POST">
                      <div class="col-sm-12">
                          <div class="row">
                              <div class="col-sm-4 form-group">
                                  <label for="projectName">First Name</label>
                                  <input type="text" class="form-control" name="FirstName" id="FirstName" value="<?php echo $StudentData['firstname']  ?>" required>
                              </div>
                              <div class="col-sm-4 form-group">
                                  <label for="projectName">Middle Name</label>
                                  <input type="text" class="form-control" name="MiddleName" id="MiddleName" value="<?php echo $StudentData['middlename']  ?>" required>
                              </div>
                              <div class="col-sm-4 form-group">
                                  <label for="projectName">Last Name</label>
                                  <input type="text" class="form-control" name="LastName" id="LastName" value="<?php echo $StudentData['lastname']  ?>" required>
                              </div>
                          </div>
                      </div>
                      ...
                      <div class="col-sm-12">
                          <div class="row">
                              <div class="col-sm-6 form-group">
                                  ...
                                  <input type="text" class="form-control" name="PhoneNo" id="PhoneNo" value="<?php echo $StudentData['phoneno']  ?>" required>
                              </div>
                              <div class="col-sm-6 form-group">
                                  <label for="projectName">Whastapp Number</label>
                                  <input type="text" class="form-control" name="WhatsappNo" id="WhatsappNo" value="<?php echo $StudentData['whatsappno']  ?>" required>
                              </div>
                      ...
                      <div class="form-group">
                          ...
                          <input type="date" class="form-control" name="DOB" id="DOB" value="<?php echo $StudentData['dob']  ?>" required>
                      </div>

                      <div class="form-group">
                          <label for="language">Insta ID</label>
                          <input type="text" class="form-control" name="instaid" id="instaid" value="<?php echo $StudentData['instaid']  ?>">
                      </div>
                      ...
                      <div class="col-sm-12">
                          <div class="row">
                              <div class="col-sm-6 form-group">
                                  <label for="projectName">Street</label>
                                  <input type="text" class="form-control" name="Street" id="Street" value="<?php echo $StudentData['pstreet']  ?>" required>
                              </div>
                              <div class="col-sm-6 form-group">
                                  <label for="projectName">City</label>
                                  <input type="text" class="form-control" name="City" id="City" value="<?php echo $StudentData['pcity']  ?>" required>
                              </div>
                      ...
                      <div class="col-sm-12">
                          <div class="row">
                              <div class="col-sm-6 form-group">
                                  ...
                                  <input type="text" class="form-control" name="State" id="State" value="<?php echo $StudentData['pstate']  ?>" required>
                              </div>
                              <div class="col-sm-6 form-group">
                                  <label for="projectName">Pincode</label>
                                  <input type="text" class="form-control" name="Pincode" id="Pincode" value="<?php echo $StudentData['ppincode']  ?>" required>
                              </div>
