 				...
 				<div class="container">
 					<div class="header-content">
 						...
 						<div class="mid-content">
 							...
 							<h5 class="mb-0" style="color:#0093dd ">Project</h5>
        ...
        <div class="floating-code code5">#include &lt;stdio.h&gt;</div>
 		...
 		<div class="page-content">
 			<div class="form-container" data-aos="zoom-in">
 				...
 				<form class="animated-form" action="<?php echo base_url('/Student/studentprojectupdate') ?>" method="POST">
 					<div class="form-group">
 						<input type="text" class="form-control" id="id" name="id" value="<?php echo $ProjectData['id'] ?>" required hidden readonly>
 						<label for="projectName">Project Name</label>
 						<input type="text" class="form-control" name="projectName" id="projectName" value="<?php echo $ProjectData['projectname'] ?>" required>
 					</div>
 					<div class="form-group">
 						<label for="language">Language</label>
 						<input type="text" class="form-control" name="language" id="language" value="<?php echo $ProjectData['languages'] ?>" required>
 					</div>
 					<div class="form-group" style="display: flex; gap: 10px;">
 						<div style="width: 50%;">
 							<label for="startDate">Start Date</label>
 							<input type="date" class="form-control" name="startDate" id="startDate" value="<?php echo $ProjectData['startdate'] ?>" required>
 						</div>
 						<div style="width: 50%;">
 							<label for="endDate">End Date</label>
 							<input type="date" class="form-control" name="endDate" id="endDate" value="<?php echo $ProjectData['enddate'] ?>" required>
 						</div>
 					</div>
 					<div class="form-group" style="display: flex; gap: 10px;">
 						<div style="width: 50%;">
 							<label for="projectType">Project Type</label>
 							<!-- <input type="text" class="form-control" name="projectType" id="projectType" value="<?php echo $ProjectData['type'] ?>" required> -->
 							<select name="projectType" id="projectType" >
 								<option value="">Select Project Type</option>
 								<option value="Single" <?= ($ProjectData['type'] == 'Single') ? 'selected' : '' ?>>Single</option>
 								<option value="Group" <?= ($ProjectData['type'] == 'Group') ? 'selected' : '' ?>>Group</option>
 							</select>
 						</div>
 						<div style="width: 50%;">
 							<label for="clientName">Client Name</label>
 							<input type="text" class="form-control" name="clientName" id="clientName" value="<?php echo $ProjectData['clientname'] ?>" required>
 						</div>
 					</div>
