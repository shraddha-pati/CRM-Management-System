    ...
    <header class="inner-header">
        ...
        <div style="text-align: end;margin-right:50px">
             <a  href="<?php echo base_url('/Student/studentproject')?>" style="border: 1px solid black;padding:5px;">Add Project</a>
         </div>
        <div class="container">
            <!-- <h3 class="mb-3" style="color: #0093dd;">Project List</h3> -->
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php foreach ($ProjectList as $row): ?>
                            <tr style="background-color: #d1e3f6;">
                                <!-- <td><?php echo $row['id'] ?></td> -->
                                <td><a href="<?php echo base_url('/student/projectedit/' . $row['id'] . '') ?>"><i class="fa fa-pencil" style="color: #0093dd;"></i></a></td>
                    ...
                    <td>Student Inquiry Management System</td>
                    <td>HTML, CSS, JavaScript, Bootstrap, PHP/CodeIgniter, MySQL</td>
                    <td>2025-01-25</td>
                    <td>Ongoing</td>
                    <td>1</td>

                    <td>ABC Training Center</td>
                </tr> -->
                    </tbody>
                </table>
            </div>
