...
<div class="page-content">
	<div class="form-container" data-aos="zoom-in">
		...
		<form class="animated-form" action="<?= base_url('/student/reportsave') ?>" method="POST" enctype="multipart/form-data">
			<div class="form-group">
				<label for="reportimage">Report File</label>
				<input type="file" class="form-control" name="reportimage" id="reportimage" required>
			</div>
